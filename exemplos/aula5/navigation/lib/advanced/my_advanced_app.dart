...
class _MainAdvancedAppState extends State<MainAdvancedApp> {
  ...
  ShopListRouterInformationParser routerInformationParser =
      ShopListRouterInformationParser();
  ...
  Future<ShopListRouteConfig> parseRouteInformation(
    ...
    if (uri.pathSegments.length == 2) {
      ...
      if (uri.pathSegments[0] != 'items') {
        return ShopListRouteConfig.nestedItemRoute(
            uri.pathSegments[0], 'item $id', id);
      }

      // return example items 0
      return ShopListRouteConfig.details('item $id', id);
    }
